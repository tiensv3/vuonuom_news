<div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="/admin/Dashboard.php"><img src="/admin/assets/images/logo.svg"
                    alt="logo" /></a>
            <a class="navbar-brand brand-logo-mini" href="/admin/Dashboard.php"><img src="assets/images/logo-mini.svg"
                    alt="logo" /></a>
        </div>
                ...
                <li class="nav-item nav-profile dropdown">
                    <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown"
                        ...
                        <div class="nav-profile-img">
                            <img src="/admin/assets/images/faces/face.png" alt="image">
                        </div>
                    ...
                    <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm"
                        ...
                        <div class="p-2">
                            <!-- <h5 class="dropdown-header text-uppercase pl-2 text-dark">Cài đặt</h5>
